    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="bejelentkezes">Admin bejelentkezés <span class="sr-only">(current)</span></a>
        </li>
      </ul>
    </div>
  </nav>
  <div class="container-contact3">
    <div class="wrap-contact3">
      ...
      <form action = "{{url('uj_hibajegy')}}" method = "post" class="contact3-form validate-form" >
        ...
        <div class="wrap-input3 validate-input">
          <textarea class="input3" name="tartalom" placeholder="Hibajegy leírása"></textarea>
          <span class="focus-input3"></span>
        </div>
